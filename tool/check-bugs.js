...
try {
  ...
  console.log('\nTo use this script, you need to authenticate:');
  console.log('1. Run: firebase login');
  console.log('2. Run: export GOOGLE_APPLICATION_CREDENTIALS="path/to/service-account.json"');
...
async function checkBugReports() {
  ...
  try {
    ...
    if (pendingCount > 0) {
      ...
      console.log('   → node tool/sync-bugs-to-github.js');
    ...
    console.error('2. Check your Firebase project is selected: firebase use');
